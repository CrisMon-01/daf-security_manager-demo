...
import it.gov.***REMOVED***.common.authentication.Authentication
import org.pac4j.play.store.PlaySessionStore
import play.api.Configuration
import it.gov.***REMOVED***.securitymanager.service.RegistrationService
import scala.concurrent.Future
import it.gov.***REMOVED***.sso.ApiClientIPA
...
import it.gov.***REMOVED***.ftp.SftpHandler
import it.gov.***REMOVED***.common.sso.common.CredentialManager
import it.gov.***REMOVED***.securitymanager.service.utilities.RequestContext._
import it.gov.***REMOVED***.common.sso.common.CacheWrapper
import it.gov.***REMOVED***.securitymanager.service.utilities.Utils
import it.gov.***REMOVED***.securitymanager.service.ProfilingService
import cats.data.EitherT
import it.gov.***REMOVED***.sso
import cats.implicits._
import it.gov.***REMOVED***.common.sso.common.{Editor,SysAdmin,Admin,Viewer}
